...
from my_dagster_project.defs.assets import raw_obs_bla, validated_structure_bla, deduplicated_bla, flagged_data_bla, raw_obs_inat
...
defs = Definitions(
    assets=[raw_obs_bla, validated_structure_bla, deduplicated_bla, flagged_data_bla, raw_obs_inat],
    jobs=[inventory_job],
