...
BLA_ASSET_SCHEMA = [
    {"name": "survey_id",                              "type": "BIGINT"},
    {"name": "program_id",                             "type": "BIGINT"},
    {"name": "program_name",                           "type": "NVARCHAR", "length": 255},
    {"name": "survey_point_id",                        "type": "BIGINT"},
    {"name": "lat",                                    "type": "FLOAT"},
    {"name": "lon",                                    "type": "FLOAT"},
    {"name": "accuracy_in_metres",                     "type": "FLOAT"},
    {"name": "start_date",                             "type": "NVARCHAR", "length": 50},
    {"name": "start_time",                             "type": "NVARCHAR", "length": 50},
    {"name": "duration_in_minutes",                    "type": "FLOAT"},
    {"name": "observer_count",                         "type": "BIGINT"},
    {"name": "survey_type_id",                         "type": "BIGINT"},
    {"name": "survey_type",                            "type": "NVARCHAR", "length": 255},
    {"name": "source_id",                              "type": "BIGINT"},
    {"name": "source_code",                            "type": "NVARCHAR", "length": 100},
    {"name": "all_species_recorded",                   "type": "BIT"},
    {"name": "water_level_cat",                        "type": "NVARCHAR", "length": 100},
    {"name": "is_private",                             "type": "BIT"},
    {"name": "sighting_id",                            "type": "BIGINT"},
    {"name": "taxon_id",                               "type": "NVARCHAR", "length": 100},
    {"name": "common_name",                            "type": "NVARCHAR", "length": 255},
    {"name": "scientific_name",                        "type": "NVARCHAR", "length": 255},
    {"name": "individual_count",                       "type": "BIGINT"},
    {"name": "vetting_id",                             "type": "BIGINT"},
    {"name": "vetting_status",                         "type": "NVARCHAR", "length": 255},
    {"name": "all_shorebirds_visible_counted",         "type": "BIT"},
    {"name": "complete_count",                         "type": "BIT"},
    {"name": "tide_category",                          "type": "NVARCHAR", "length": 100},
    {"name": "wind_speed_category",                    "type": "NVARCHAR", "length": 100},
    {"name": "wind_dir_category",                      "type": "NVARCHAR", "length": 50},
    {"name": "disturbance_people_count",               "type": "FLOAT"},
    {"name": "disturbance_dogs_off_lead_count",        "type": "FLOAT"},
    {"name": "disturbance_dogs_on_lead_count",         "type": "FLOAT"},
    {"name": "disturbance_watercraft_at_anchor_count", "type": "FLOAT"},
    {"name": "disturbance_watercraft_moving_count",    "type": "FLOAT"},
